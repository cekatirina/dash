...
with tab1:
        ...
        with col1:
                st.markdown('##### Описание переменных', help = 'Данные содержат в себе информацию о повышениях в компании за последний год.\n В данных содержится информация о 40 тыс. сотрудниках')
                st.table(vars_df)
        with col2:
