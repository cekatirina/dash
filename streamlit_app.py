...
with tab2:
        ...
        with st.form(key="dash_form"):
            st.markdown('#### Вам будет представлен ряд утвержений по поводу доверия модели, объяснение который вы изучили 
                на дэшборде. **Оцените каждое утверждение по шкале от 1 до 7** (1 - полностью НЕ согласен, 7 - полностью согласен)')
