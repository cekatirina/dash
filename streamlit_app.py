...
with tab1:
        ...
        with column1:
                ...
                st.markdown('**Возраст:** 28 лет')
                st.markdown('**Образование:** высшее (бакалавриат)')
                st.markdown('**Отдел:** технологический')
                st.markdown('**Как давно работает в компании:** 5 лет')
                st.markdown('**Рейтинг за предыдущий год:** 1/5')
        ...
        with column2:
                ...
                st.markdown('**Возраст:** 56 лет')
                st.markdown('**Образование:** высшее (магистратура)')
                st.markdown('**Отдел:** исследования и разработки')
                st.markdown('**Как давно работает в компании:** 17 лет')
                st.markdown('**Рейтинг за предыдущий год:** 5/5')
                st.markdown('**Кол-во курсов, пройденных в рамках корпоративного обучения за посл. год:** 1')
                st.markdown('**Средняя оценка за пройденные курсы:** 87/100 ')
